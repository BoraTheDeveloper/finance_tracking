...
export function DueDayPicker({ label, value, theme, onChange }: { label: string; value: number; theme: Theme; onChange: (day: number) => void }) {
  return (
    <View>
...
export function SheetInput({ label, value, theme, onChange }: { label: string; value: string; theme: Theme; onChange: (value: string) => void }) {
...
export function MoneyField({ label, initialAmount, initialCur = 'USD', rate, theme, onChange, right }: { label: string; initialAmount: number; initialCur?: Currency; rate: number; theme: Theme; onChange: (usd: number, amount: number, cur: Currency) => void; right?: ReactNode }) {
