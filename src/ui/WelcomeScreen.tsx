...
export function WelcomeScreen({ theme, onStart }: WelcomeScreenProps) {
  ...
  const chips = useRef(
    WELCOME_CHIPS.map(() => new Animated.Value(reducedMotion ? 1 : 0)),
  ).current;
  ...
  useEffect(() => {
    ...
    Animated.sequence([
      ...
      Animated.stagger(
        70,
        chips.map((value) => timing(value, 1, 180)),
      ),
    ...
    <View style={{ flex: 1, backgroundColor: theme.page }}>
      <ScrollView
        contentContainerStyle={[
          styles.scroll,
          { paddingBottom: Math.max(132, footerBottomPadding + 104) },
        ]}
      ...
      >
        ...
        <Animated.View style={animatedIntroStyle(hero, 8)}>
          <AppText
            ...
            style={[styles.heroTitle, { color: theme.text, marginTop: 0 }]}
          >
            Spend calm today
          </AppText>
          <AppText
            style={[
              styles.subtitle,
              { color: theme.muted, fontSize: 16, lineHeight: 22 },
            ]}
          >
          ...
          >
            Track cash, ABA, or KHQR in seconds.
          </AppText>
          <View
            style={[
              styles.card,
          ...
          >
            ...
            <View style={{ flex: 1 }}>
              ...
              <AppText
                style={[styles.itemSub, { color: theme.muted, marginTop: 4 }]}
              >
                No account. Data stays here.
              </AppText>
            </View>
          </View>
        </Animated.View>
        ...
        <View
          style={{ marginTop: 16 }}
          accessibilityLabel="Welcome promises"
          accessible
        >
          ...
          <View style={styles.chipRow}>
            {WELCOME_CHIPS.map((chip, index) => (
              <Animated.View
                key={chip.label}
                style={[
                  animatedIntroStyle(chips[index], 8),
                  styles.chip,
              ...
              >
                ...
                <AppText style={[styles.chipText, { color: theme.muted }]}>
                  {chip.label}
                </AppText>
              </Animated.View>
            ))}
      ...
      >
        <AppText
          style={[
            styles.itemSub,
            { color: theme.muted, textAlign: "center", marginBottom: 8 },
          ]}
        >
        ...
        <AnimatedPressable
          ...
          accessibilityLabel="Set up my budget"
