...
export const styles = StyleSheet.create({
  ...
  ringCenter: { position: 'absolute', alignItems: 'center', maxWidth: 168 },
  ...
  ringKhr: { fontSize: 13, fontFamily: FONT.semibold, marginTop: 4, textAlign: 'center' },
  ...
  button: { minHeight: 54, borderRadius: 18, flexDirection: 'row', gap: 8, alignItems: 'center', justifyContent: 'center', paddingHorizontal: 18, overflow: 'hidden' },
  buttonContent: { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 8, minWidth: 0 },
  buttonIcon: { marginTop: 1 },
  buttonText: { color: '#fff', fontFamily: FONT.bold, fontSize: 16, lineHeight: 20, flexShrink: 1, textAlign: 'center' },
  ...
  footer: { position: 'absolute', left: 0, right: 0, bottom: 0, paddingHorizontal: 16, paddingTop: 12, paddingBottom: 16, borderTopWidth: 1 },
  ...
  swatch: { width: 42, height: 42, borderRadius: 12, borderWidth: 3, borderColor: 'transparent' },
  ...
  iconPickSpacer: { width: 46, height: 0 },
