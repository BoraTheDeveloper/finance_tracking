...
def main():
    ...
    print(f'  {"-" * 68}')
    print(f'  {"Top-1 Accuracy":<30s} {val_metrics["accuracy"]:>12.4f} {test_metrics["accuracy"]:>12.4f} {">= 0.85":>12s}')
    ...
    print(f'  {"Wrong-High-Conf":<30s} {val_metrics["whc"]:>12.4f} {test_metrics["whc"]:>12.4f} {"<= 0.03":>12s}')
    ...
    if val_metrics['accuracy'] < 0.85:
        print(f'\n  ⚠  val accuracy {val_metrics["accuracy"]:.4f} < 0.85')
    else:
        print(f'\n  ✅ val accuracy passes')
    if val_metrics['whc'] > 0.03:
        print(f'  ⚠  val wrong-high-confidence {val_metrics["whc"]:.4f} > 0.03')
        gates_pass = False
    else:
        print(f'  ✅ val wrong-high-confidence passes')
    ...
    return {'val_acc': val_metrics['accuracy'], 'test_acc': test_metrics['accuracy'],
            'val_f1': val_metrics['f1'], 'val_whc': val_metrics['whc'],
